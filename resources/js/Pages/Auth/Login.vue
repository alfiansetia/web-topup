...
<template>
    <GuestLayout>
        ...
        <div
            ...
            class="mb-5 flex items-start gap-3 rounded-xl bg-red-50 border border-red-100 px-4 py-3.5 text-sm text-red-700"
        >
            <svg
        ...
        <div
            v-if="status"
            class="mb-5 flex items-start gap-3 rounded-xl bg-green-50 border border-green-100 px-4 py-3.5 text-sm text-green-700"
        >
            <svg
        ...
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <PrimaryButton
                class="w-full justify-center py-3 rounded-xl text-sm font-semibold shadow-sm hover:shadow-md transition-all duration-200"
